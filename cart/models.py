...
class Cart(models.Model):
    product = models.ForeignKey('product.Product', on_delete=models.CASCADE, related_name='carts', null=True)
    voucher = models.ForeignKey('voucher.Voucher', on_delete=models.CASCADE, related_name='carts', null=True)
